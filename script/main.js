...
for (let i = 0; i < decreasePriority.length; i++) {
    decreasePriority[i].addEventListener("click", function () {
        myData[i].priorityLevel--;                                               /*the function reduce the priority level only,the thought was to delete the card with result.splice(i,1), will need help with this matter*/
